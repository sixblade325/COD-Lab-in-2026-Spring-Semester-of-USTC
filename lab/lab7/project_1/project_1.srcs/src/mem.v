module mem#(
    ...
    assign addr = mem_addr[MEM_ADDR_WIDTH - 1 + LINE_OFFSET_WIDTH + SPACE_OFFSET:LINE_OFFSET_WIDTH + SPACE_OFFSET];
    //Attention: Derek has fixed the above line, the original line is:
